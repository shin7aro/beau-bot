...
───────────────────────────────────────── */
// ITEM_MAP now lives in the shared js/item-map.js (loaded before this
// file); imgUrl() below also comes from there. Referenced explicitly here
// (rather than relying on bare identifiers finding window.* implicitly)
// so this still works regardless of how the pages load these scripts.
