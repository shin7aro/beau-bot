...
// items.xml's craftingspelllist per item, spells.xml's uisprite/
// category per spell, localization.xml for the @SPELLS_<uniquename>
// display-name lookup) on 2026-09-14. If item-map.js's ITEM_MAP gains
// a new weapon/head/chest/feet entry, or Albion changes a weapon's
// ability list, this (and its public/js twin) needs regenerating from
// the same source — it is not derived at runtime.
